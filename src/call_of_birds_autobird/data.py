...
def preprocess(
    ...
    pad_last: bool = typer.Option(True, help="Whether to pad the last chunk"),
    ...
    data_cfg = DataConfig(
        train_split=train_split, seed=seed, clip_sec=clip_sec, stride_sec=stride_sec, pad_last=pad_last
    )
