...
_CALL_OF_FUNC_ROOT = os.path.join(_PROJECT_ROOT, "src/call_of_func")  # root of call_of_func folder
_DATACLASSES_ROOT = os.path.join(_CALL_OF_FUNC_ROOT, "dataclasses")  # root of dataclasses folder
